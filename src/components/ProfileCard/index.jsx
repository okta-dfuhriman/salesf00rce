	...
	<div className='avatar'>
		<div style={{ position: 'absolute', top: '-6px' }}>
			<div className='slds-is-relative slds-m-right_medium user-avatar'>
				<LDS.Button
					style={{ backgroundImage: "url('/assets/images/astro.svg')" }}
...
const Details = () => (
	<div className='details'>
		...
		<div className='location'>California, United States</div>
			...
			<div className='footer'>
				<div className='slug'>
					<img
						...
						class='slug-icon'
					/>
					<textarea tabindex='-1' aria-hidden='true' class='slug-value'>
